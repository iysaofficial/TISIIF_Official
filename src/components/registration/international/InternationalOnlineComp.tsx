  ...
  const price = useMemo(() => {
    switch (competitionCategory) {
      case "Online Competition":
        return "105 USD";
      case "Online Competition + Certificate and Medal (SOUTH EAST ASIA)":
        return "225 USD";
      ...
      <div className="registration-form">
        <form name="regist-form">
          <BiodataSection
            ...
            handleCompetitionCategoryChange={handleCompetitionCategoryChange}
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        ...
        <select
          ...
          onChange={handleCompetitionCategoryChange}
        >
    ...
    <div className="field-grid">
      <div className="field-group">
        ...
        <div className="char-counter" style={{ color: charCounterColor }}>
          {selectedMaxNamaLengkap.length} / 180 Character
        </div>
      </div>
  ...
  <section className="form-section">
    ...
    <div className="field-grid">
      <div className="field-group">
        ...
        <div className="field-note">
          <p>
            If you dont have whatsapp number, please write down your social
            media account. (Ex: Instagram/FB/Telegram/Line)
          </p>
          <div className="example-box">
