...
const InternationalOnlineComp: React.FC = () => {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbx6Mllkg1A0BfagavfMuv2X8ExhKOSMuwOyYpK1HCnGHbqvfgT4XEs5dHjNt6lOS7paLA/exec";
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        ...
        <select name="COMPETITION_CATEGORY" className="select-field" required>
          ...
          <option value="Online Competition + Certificate and Medal (SOUTH EAST ASIA)">Online Competition + Certificate and Medal (SOUTH EAST ASIA)</option>
          <option value="Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)</option>
        </select>
      </div>
    </div>
