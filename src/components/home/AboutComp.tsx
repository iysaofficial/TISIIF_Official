        ...
        <div className="about-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              An international platform fostering creativity and innovation for
              a better future.
            </p>
          </div>
          ...
          <div className="about-content">
            ...
            <div className="about-text">
              <p className="about-description">
                Creating innovative works is a must in todays modern era. These
                demands can be pursued by students and students as a milestone
                for the future of a nation. With this in mind, the Indonesian
                Young Scientist Association (IYSA) and Next Generation Knowledge
                ...
                COmpetition on Innovation Science.
              </p>

              <p className="about-description">
                TISIIF is a competition for creativity in the field of
                scientific innovation and invention among students ( Elementary,
